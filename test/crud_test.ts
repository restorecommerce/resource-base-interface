...
describe('ServiceBase', () => {
  ...
  describe('endpoints', () => {
    ...
    describe('read', () => {
      ...
      it('should return only resources with number filter value greater than 10', async () => {
        const filters = {
          filter: {
            field: 'value',
    ...
    describe('delete', () => {
      ...
      it('should delete all specified documents', async () => {
    ...
    describe('update', () => {
      it('should update all specified documents', async () => {
    ...
    describe('upsert', () => {
      it('should create or updae specified documents', async () => {
        const now = Date.now();
        const replace = [{
          id: testData[2].id,
          value: 0,
    ...
    describe('check required fileds', () => {
      it('should throw an error when trying to add ', async () => {
